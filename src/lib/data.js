export const posts = [
...

    {
        ...
        paragraphs: [
            {   
                imgSrc: "/images/recreation/Bauman_street.jpg",
                title: "Отдых",
                text: "Улица Баумана — главная и частично пешеходная улица в Казани, расположенная в историческом центре города, в Вахитовском районе. Является ядром Казанского посада.",
            },
            {
                text: "Улица Баумана — одна из самых старых улиц Казани. В эпоху Казанского ханства она называлась Ногайской дорогой. В 1552 году, во время штурма Казанского Кремля московскими войсками Ивана Грозного, обе его стены южнее и севернее улицы были проломлены взрывами, а улица была названа сначала Проломной, а затем Большой Проломной. В XVI веке, продолжая уже имевшуюся застройку северной части улицы, в её южной части возникла Новая слобода, получившая позже название Богоявленской по названию сооружённой здесь церкви. В 1930 году, улица была переименована в честь выходца из Казани революционера Баумана. Это название сохранилось до настоящего времени, хотя в постсоветское время предлагалось её переименовать в улицу Шаляпина. Улица была красиво благоустроена и декорирована в начале 1990-х годов, а первой в городе пешеходной зоной стала в 1996 году. До этого по улице по проложенной в 1948 году первой в городе линии троллейбуса ходили его маршруты № 1,4 (ранее также 7) и несколько маршрутов автобуса, до 1935 года — трамвай, до 1899 года — конка. Транспортная доступность улицы осуществляется с расположенных в её начале и конце двух станций метро, а также с площади Тукая (троллейбус и автобус), с соседних улиц Островского и Кремлёвская (автобус), Право-Булачная (троллейбус и автобус). На протяжении квартала в северной части улицы сооружена в конструкциях, но пока не отделана и не открыта (ввиду организационно-технических проблем с реконструкцией примыкающего здания гостиницы «Казань») торгово-развлекательная подземная галерея, из которой есть несколько отдельных выходов на улицу, а также предусмотрен выход в южный вестибюль станции метро «Кремлёвская».",
            },
        ],
    },
];
